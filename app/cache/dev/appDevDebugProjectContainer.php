...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/dev/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $c = new \Assetic\Cache\ConfigCache('C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/dev/assetic/config');
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, '', 'C:/xampp/htdocs/projects/playlist.localhost/www/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($b, '', 'C:/xampp/htdocs/projects/playlist.localhost/www/app/Resources/views', '/\\.[^.]+\\.php$/'), 'php');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/xampp/htdocs/projects/playlist.localhost/www/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_521e3a9ab5a9e70b9e3531b0943727e4');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_521e3a9ab5a9e70b9e3531b0943727e4');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_521e3a9ab5a9e70b9e3531b0943727e4');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => 'C:\\xampp\\htdocs\\projects\\playlist.localhost\\www\\src\\Acme\\RegistrationBundle\\Entity', 1 => 'C:\\xampp\\htdocs\\projects\\playlist.localhost\\www\\src\\Acme\\TaskBundle\\Entity', 2 => 'C:\\xampp\\htdocs\\projects\\playlist.localhost\\www\\src\\TutorialSF2\\SearchEngineBundle\\Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Acme\\RegistrationBundle\\Entity');
        $f->addDriver($e, 'Acme\\TaskBundle\\Entity');
        $f->addDriver($e, 'TutorialSF2\\SearchEngineBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('AcmeRegistrationBundle' => 'Acme\\RegistrationBundle\\Entity', 'AcmeTaskBundle' => 'Acme\\TaskBundle\\Entity', 'TutorialSF2SearchEngineBundle' => 'TutorialSF2\\SearchEngineBundle\\Entity'));
        $g->setMetadataCacheImpl($b);
        $g->setQueryCacheImpl($c);
        $g->setResultCacheImpl($d);
        $g->setMetadataDriverImpl($f);
        $g->setProxyDir('C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/xampp/htdocs/projects/playlist.localhost/www/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/xampp/htdocs/projects/playlist.localhost/www/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    /**
     * Gets the 'searcher' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Acme\TestBundle\Lib\Searcher\Searcher A Acme\TestBundle\Lib\Searcher\Searcher instance.
     */
    protected function getSearcherService()
    {
        return $this->services['searcher'] = new \Acme\TestBundle\Lib\Searcher\Searcher();
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Acme\\RegistrationBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha1', 1 => false, 2 => 1))));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/xampp/htdocs/projects/playlist.localhost/www/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/xampp/htdocs/projects/playlist.localhost/www/app', 'UTF-8');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/xampp/htdocs/projects/playlist.localhost/www/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\xampp\\htdocs\\projects\\playlist.localhost\\www\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\xampp\\htdocs\\projects\\playlist.localhost\\www\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\xampp\\htdocs\\projects\\playlist.localhost\\www\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\xampp\\htdocs\\projects\\playlist.localhost\\www\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\xampp\\htdocs\\projects\\playlist.localhost\\www\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\xampp\\htdocs\\projects\\playlist.localhost\\www\\src\\Acme\\IndexBundle/Resources/views', 'AcmeIndex');
        $instance->addPath('C:\\xampp\\htdocs\\projects\\playlist.localhost\\www\\src\\Acme\\RegistrationBundle/Resources/views', 'AcmeRegistration');
        $instance->addPath('C:\\xampp\\htdocs\\projects\\playlist.localhost\\www\\src\\Acme\\TaskBundle/Resources/views', 'AcmeTask');
        $instance->addPath('C:\\xampp\\htdocs\\projects\\playlist.localhost\\www\\src\\TutorialSF2\\SearchEngineBundle/Resources/views', 'TutorialSF2SearchEngine');
        $instance->addPath('C:\\xampp\\htdocs\\projects\\playlist.localhost\\www\\src\\Acme\\AdminBundle/Resources/views', 'AcmeAdmin');
        $instance->addPath('C:\\xampp\\htdocs\\projects\\playlist.localhost\\www\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('C:\\xampp\\htdocs\\projects\\playlist.localhost\\www\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\xampp\\htdocs\\projects\\playlist.localhost\\www\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/xampp/htdocs/projects/playlist.localhost/www/app/Resources/views');
        $instance->addPath('C:\\xampp\\htdocs\\projects\\playlist.localhost\\www\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/xampp/htdocs/projects/playlist.localhost/www/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.administrators'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AcmeRegistrationBundle:User', NULL, NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/xampp/htdocs/projects/playlist.localhost/www/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/dev',
            'kernel.logs_dir' => 'C:/xampp/htdocs/projects/playlist.localhost/www/app/logs',
            'kernel.bundles' => array(
                ...
                'AcmeRegistrationBundle' => 'Acme\\RegistrationBundle\\AcmeRegistrationBundle',
                'AcmeTaskBundle' => 'Acme\\TaskBundle\\AcmeTaskBundle',
                'TutorialSF2SearchEngineBundle' => 'TutorialSF2\\SearchEngineBundle\\TutorialSF2SearchEngineBundle',
            ...
            'debug.container.dump' => 'C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\xampp\\htdocs\\projects\\playlist.localhost\\www\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => 'C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/dev/swiftmailer/spool',
            ...
            'assetic.cache_dir' => 'C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/xampp/htdocs/projects/playlist.localhost/www/app/../web',
            'assetic.write_to' => 'C:/xampp/htdocs/projects/playlist.localhost/www/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/dev/doctrine/orm/Proxies',
