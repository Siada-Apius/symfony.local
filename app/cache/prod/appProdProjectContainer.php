...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $a = $this->get('assetic.asset_factory');
        $b = $this->get('templating.loader');
        $c = new \Assetic\Cache\ConfigCache('C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/prod/assetic/config');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_f2813c94d6edba8e06fb307480adc4d3');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_f2813c94d6edba8e06fb307480adc4d3');
        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_f2813c94d6edba8e06fb307480adc4d3');
        ...
        $g->setProxyDir('C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('C:/xampp/htdocs/projects/playlist.localhost/www/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/xampp/htdocs/projects/playlist.localhost/www/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/prod',
            ...
            'session.save_path' => 'C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/prod/sessions',
            ...
            'router.resource' => 'C:/xampp/htdocs/projects/playlist.localhost/www/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.memory.path' => 'C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/prod/swiftmailer/spool',
            ...
            'assetic.cache_dir' => 'C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'C:/xampp/htdocs/projects/playlist.localhost/www/app/cache/prod/doctrine/orm/Proxies',
