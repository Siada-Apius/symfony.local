...
class Users
{
     ...
     * Add role
     *
     * @param \Acme\SearchBundle\Entity\Roles $role
     * @return Users
     */
    public function addRole(\Acme\SearchBundle\Entity\Roles $role)
    {
        $this->role[] = $role;
     ...
     * @param \Acme\SearchBundle\Entity\Roles $role
     */
    public function removeRole(\Acme\SearchBundle\Entity\Roles $role)
    {
